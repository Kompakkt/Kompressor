...
## Prepare gsbox ##
RUN curl -L -o gsbox-amd64-linux-v3.5.0.zip https://github.com/user-attachments/files/20650902/gsbox-amd64-linux-v3.5.0.zip && \
    unzip gsbox-amd64-linux-v3.5.0.zip -d /usr/local/bin/ && \
    rm gsbox-amd64-linux-v3.5.0.zip && \
